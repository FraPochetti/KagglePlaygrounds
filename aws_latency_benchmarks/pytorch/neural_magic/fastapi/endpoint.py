...
# NOTE FROM FRANCESCO POCHETTI:
# THIS FILE IS A COPY-PASTE FROM THE ORIGINAL ONE IN THE DEEPSPARSE REPO
# HERE: https://github.com/neuralmagic/deepsparse/blob/main/examples/aws-sagemaker/endpoint.py
